...
export const DEFAULT_ROUTING_MATRIX: RoutingMatrix = {
  high: {
    agent_turn: { candidates: ["gpt-5.2", "gpt-5.3", "claude-sonnet-4-5"], maxTokens: 8192, ceilingCents: -1 },
    heartbeat_triage: { candidates: ["gpt-5-mini", "claude-haiku-4-5"], maxTokens: 2048, ceilingCents: 5 },
    safety_check: { candidates: ["gpt-5.2", "claude-sonnet-4-5"], maxTokens: 4096, ceilingCents: 20 },
    summarization: { candidates: ["gpt-5-mini", "claude-haiku-4-5"], maxTokens: 4096, ceilingCents: 15 },
    planning: { candidates: ["gpt-5.2", "claude-sonnet-4-5"], maxTokens: 8192, ceilingCents: -1 },
  },
  normal: {
  ...
  low_compute: {
    agent_turn: { candidates: ["gpt-5-mini", "claude-haiku-4-5"], maxTokens: 4096, ceilingCents: 10 },
